...
%%%% E-to-E %%%%
    new.F_ee   = last.F_ee + dt*SS.gamma_e.^2*(-2/SS.gamma_e*last.F_ee - last.Phi_ee ...
...
%%%% E-to-I %%%%
    new.F_ei   = last.F_ei+dt*SS.gamma_e.^2*(-2/SS.gamma_e*last.F_ei - last.Phi_ei ...
...
%%%% I-to-E %%%%
    new.F_ie   = last.F_ie     +dt*SS.gamma_i.^2*(-2/SS.gamma_i*last.F_ie - last.Phi_ie ...
                        +SS.Nie_b*last.Qi);     %short range
    new.Phi_ie = last.Phi_ie + dt*last.F_ie;

%%%% I-to-I %%%%
    new.F_ii   = last.F_ii     +dt*SS.gamma_i.^2*(-2/SS.gamma_i*last.F_ii - last.Phi_ii ...
...
% 5. Update extracellular ion.
    ...
    new.K(2:Nx-1,2:Ny-1) =    last.K(2:Nx-1,2:Ny-1) ...
                            + dt/PK.tau_K*(-PK.k_decay*last.K(2:Nx-1,2:Ny-1) ...   % decay term.
                            ...                                         % reaction term.
